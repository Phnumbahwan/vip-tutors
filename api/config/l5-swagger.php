...
return [
    ...
    'documentations' => [
        'default' => [
            'api' => [
                'title' => 'VIP Tutors API Documentation',
            ],
        ...
        */
        'ui' => [
            'display' => [
                ...
                /**
                 * If set, the request sample will be persisted using 'Try it out',
                 * so that users can customize the request parameters and then execute
